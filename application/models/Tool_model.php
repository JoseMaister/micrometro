...
class Tool_model extends CI_Model {
    ...
    public function ubicaciones($idp){
        $this->db->select('u.*, u.defecto as ubi_defecto, p.*');        
...
function pedidosPendientes(){
    ...
    public function movimientos(){
        ...
        $this->db->where('m.tipo !=','MODIFICACION');
    ...
    function updateFoto($id_auto, $datos)
    {
        $this->db->where('idProducto', $id_auto);
...
public function listadoMarcas(){
    ...
    public function getModelos($paisid) {
        $this->db->where('id_marca', $paisid);
    ...
    public function getYear($paisid) {
        $this->db->where('Nombre', $paisid);
    ...
    public function guardarDatos($datos) {
        $this->db->db_debug = FALSE;
        if($this->db->insert('compatibles', $datos)){
          return $this->db->insert_id();
        }
        else {
          return FALSE;
