   ...
   <div class="">
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               <div class="x_title">
                  <h2>Catalogo Venta de Servicios</h2>
               ...
               <div class="x_content">
                 <!--    <div class="col-md-12 col-sm-12 col-xs-12">
                        <p style="display: inline;">
                           ...
                           Numero Cliente : 
                           <input type="radio" class="flat" name="rbBusqueda" id="numero_cliente" value="numero_cliente"/>
                           Correo Cliente : 
                           <input type="radio" class="flat" name="rbBusqueda" id="correo_cliente" value="correo_cliente"/>
                        </p>
...
<script src=<?= base_url("application/views/ventas/js/catalogo_servicios.js"); ?>></script>
