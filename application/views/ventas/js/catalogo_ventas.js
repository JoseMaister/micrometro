...
function buscar(){
       var URL = base_url + "ventas/ajax_get_AllVentas";
           ...
           success: function(result) {
               ...
               if(result)
               {
                   ...
                   $.each(rs, function(i, elem){
                       ...
                       ren.insertCell().innerHTML = '<a href="'+base_url+'/ventas/ver_venta/' + elem.id+'"><button type="button"class="btn btn-primary btn-xs">'+elem.estatus +'</button></a>';
