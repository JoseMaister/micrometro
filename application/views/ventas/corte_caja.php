            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="x_panel">
                  <div class="x_title">
                    ...
                    <?php
                        if ($caja) {
                     if ($caja->caja == 'PARCIAL' || $caja->caja == 'TOTAL') {
                       
                     ?>
                  <a href=<?= base_url("ventas/exportar_excel/") ?> class="btn btn-success btn-xs pull-right"><i class='fa fa-send'></i> Exportar</a>
                  <?php
               }}
                  ?>
                  <div class="x_content" >
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr class="even pointer">
                                 ...
                                 <td  class="text-center">$<?= $elem->total_final ?></td>
...
<a target="_blank" href=<?= base_url("usuarios/alta_cliente"); ?>><button id="send" type="button"  class="btn btn-primary btn-xs">Agregar Cliente</button></a>         </div>
         <div class="modal-body">
            <form>
               <div id="divBusqueda">
                  <label>Buscar: </label>
...
<script src=<?= base_url("application/views/ventas/js/ver_servicio.js"); ?>></script>
