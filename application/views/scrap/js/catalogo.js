...
function buscar(){
       var URL = base_url + "scrap/ajax_getVentas";
           ...
           success: function(result) {
               ...
               if(result)
               {
                   ...
                   $.each(rs, function(i, elem){
                       ...
                       ren.insertCell().innerHTML = '<a href="'+base_url+'/scrap/ver_scrap/' + elem.id+'"><button type="button"class="btn btn-primary btn-xs">'+elem.estatus +'</button></a>';
