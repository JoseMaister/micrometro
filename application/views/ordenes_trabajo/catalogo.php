   ...
   <div class="">
            ...
            <div class="x_panel">
               ...
               <div class="x_content">
                  <p style="display: inline;">
                           Orden de Trabajo :
                           <input type="radio" class="flat" name="rbBusqueda" id="codigo" value="wo"  />
                           Contenido : 
                           <input type="radio" class="flat" name="rbBusqueda" id="user" value="contenido"/>
                        </p>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               <div class="x_content">
                  <a href=<?= base_url("ordenes_trabajo/crear_orden") ?> class="btn btn-primary btn-xs"><i class='fa fa-plus'></i> Nueva WO</a>
                  <div id="wo" class="row">
...
<script src=<?= base_url("application/views/ordenes_trabajo/js/catalogo.js"); ?>></script>
<!-- JS FILE -->
<script>
