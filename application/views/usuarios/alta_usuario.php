                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form method="POST" action=<?= base_url('usuarios/registrar') ?> class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="materno">Apellido Materno <span class="">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input style="text-transform: uppercase;" id="materno" class="form-control col-md-7 col-xs-12" name="materno" placeholder=""  type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Correo <span class="">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
