            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="table-responsive">
                        <button type="button" onclick="modalAgregar()" id="btnAlta"  class="btn btn-primary btn-xs"><i class='fa fa-plus'></i> Agregar</button>
            ...
            <div class="modal-body">
                <form>
                    <div class="col-xs-6">
                        ...
                        <br>
                        <input id="opMagnitud" style="display: inline;" type="text">
                    </div>
                    ...
                    <div class="col-xs-6">
                        ...
                        <p style="margin-left: 10px; display: inline;">
                            On-Site:
                            <input type="checkbox" class="flat" name="cbSitio" id="cbOS" value="OS" />
                            Taller Mecanico:
                            <input type="checkbox" class="flat" name="cbSitio" id="cbLab" value="LAB"/>
                            <br><br>
                            Refaccionaria:
                            <input type="checkbox" class="flat" name="cbSitio" id="cbRef" value="REF" />
                            Maquinados:
                            <input type="checkbox" class="flat" name="cbSitio" id="cbTaMa" value="TAM"/>
                    ...
                    <div class="col-xs-6">
                        ...
                        <br>
                        <input id="opPrecios" style="display: inline;" type="text">
                    </div>
