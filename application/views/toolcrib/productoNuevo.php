                    ...
                    <div class="x_content">
                        <form method="POST" action=<?= base_url('toolcrib/registrarProducto') ?> class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select required="required" class="select2_single form-control" name="tipo" id="tipo">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input style="text-transform: uppercase;" id="garantia" class="form-control col-md-7 col-xs-12" name="garantia" placeholder=""  type="text">
                                </div>
                            </div> 
                             <div class="item form-group">
                           ...
                           <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="foto" placeholder=""  type="file">
                                </div>
                            </div>
