                    ...
                    <div class="x_content">
                        <form method="POST" action=<?= base_url('toolcrib/editarProducto') ?> class="form-horizontal form-label-left" novalidate enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea style="text-transform: uppercase;" id="comentario" class="form-control col-md-7 col-xs-12" name="comentario" placeholder="" ></textarea>
                                </div>
                            </div>
                                     ...
                                     foreach ($ubicacion->result() as $elem) { ?>
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <a href=<?= base_url("toolcrib/editarProd/".$elem->idUbi); ?>><button type="button"class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> Ver Producto </button></a>
                                                 <?php
                                                 if ($elem->ubi_defecto != 1) {
                                                 ?>
                                                 <a href=<?= base_url("toolcrib/ubicacion_defecto/".$elem->idUbi); ?>><button type="button"class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Defecto </button></a>.
                                                   <?php
                                      }
                                    ?>
                                                </td>
