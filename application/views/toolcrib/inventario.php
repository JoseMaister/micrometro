                        ...
                        <!--<button onclick="agregar()" type="button" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Agregar Requisito </button>-->
                            <div class="table-responsive">
                                <table id="tabla" class="table table-bordered">
                                    <thead>
                                        <tr class="headings">
                                            <th class="column-title text-center"># Parte</th>
                                    ...
                                    if($productos) { $i = 1;
                                     foreach ($productos->result() as $elem) { ?>
                                            ...
                                            <tr class="even pointer">
                                                <td  class="text-center" style= "height: auto;"><?= $elem->codigo ?></td>
                                                <td  class="text-center" style="  height: auto;"><?= $elem->producto ?></td>
                                                <td class="text-center" style="  height: auto;"><?= $elem->descripcion ?></td>
                                                <td  class="text-center" style="  height: auto;"><?= $elem->proveedor ?></td>
                                                <td  class="text-center" style="  height: auto;"><?= $elem->marca ?></td>
                                                <td  class="text-center" style="  height: auto;"><?= $elem->modelo ?></td>
                                                
                                                <td  class="text-center" style="height: auto;"><?= "$ ".$elem->precio ?></td>
                                                <td  class="text-center" style="height: auto;"><?= $elem->um ?></td>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="lblCodigo">Autos Compatibles</h4>
            </div>
            <label id="info"></label>
             <div class="x_content">
                            <div class="table-responsive">
            ...
            <div class="modal-footer">
                <button id="btnCancelar" type="button" data-dismiss="modal" class="btn btn-default pull-left"><i class="fa fa-close"></i> Cerrar</button>
            </div>
        ...
        success: function(result) {
            ...
            if(result)
            {
                ...
                $.each(rs, function(i, elem){
                    ...
                    ren.insertCell(0).innerHTML = "<button type='button' onclick='mdlAutos("+elem.idProducto+")' class='btn btn-default btn-xs' >"+ elem.codigo+"</button>";
    ...
    $('#tabla_autos tbody tr').remove();
     $.ajax({
            ...
            success: function(result) {
                ...
                $.each(rs, function(i, elem){
                    var ren = tab.insertRow(tab.rows.length);
                    info = " #Parte : "+elem.codigo+" || Producto: "+elem.producto;
